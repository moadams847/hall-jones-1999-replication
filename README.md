...
Replication of **Hall, Robert E. and Charles I. Jones (1999)**. "Why Do Some Countries Produce So Much More Output Per Worker Than Others?" *Quarterly Journal of Economics* 114(1): 83–116.
...
│
└── outputs/
    ├── hj_master.csv           # Merged dataset (183 countries, 23 variables)
...
- **File name:** `open.csv`
- **Source:** Sachs, Jeffrey D. and Andrew Warner (1995). "Economic Reform and the Process of Global Integration." *Brookings Papers on Economic Activity* 1: 1–118.
...
- **File name:** `frankel_romer_trade.csv`  *(generated by hj_merge.py from Appendix Table A1)*
- **Source:** Frankel, Jeffrey A. and David Romer (1999). "Does Trade Cause Growth?" *American Economic Review* 89(3): 379–399.
